        ...
        <div className='row'>
          <div className="col-sm-12 col-md-8 col-lg-9">
            ...
            <ul>
              ...
              <li>I <u>do not</u> care which broker you use. I use <a href="https://www.fidelity.com/options-trading/overview" target="_new">Fidelity</a>, <a href="https://start.tastyworks.com/#/login?referralCode=SP8DSHF682" target="_new">TastyTrade</a>, and sometimes <a href="https://join.robinhood.com/kristok207" target="_new">Robinhood</a>.</li>
              <li>I want this site to be fast, clean, and mobile friendly.</li>
              <li>This website <u>does not</u> track anything. No Google Analytics and zero third-party scripts other than <a href="https://www.cloudflare.com" target="_new">Cloudflare</a> for performance &amp; security.</li>
              <li>
