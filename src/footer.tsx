    ...
    return (
        <footer>
            ...
            <Container className="p-3">
                ...
                <div style={{ "fontSize" : ".75em", "marginTop" : "1em"}}>The opinions expressed herein are my own personal opinions and do not represent my employer's view in any way.</div>
            </Container>
